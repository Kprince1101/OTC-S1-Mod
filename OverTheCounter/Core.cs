...
[assembly: MelonInfo(typeof(OverTheCounter.Core), "OverTheCounter", "2.0.10", "hdlmrell", null)]
...
namespace OverTheCounter
{
    public class Core : MelonMod
    {
        ...
        private void OnInitializeMelonImpl()
        {
            ...
            S1APINPCRelationFixPatch.Apply(HarmonyInstance);
            S1APIBrokenPatchSweeper.Apply(HarmonyInstance);
