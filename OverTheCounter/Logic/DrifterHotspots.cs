...
namespace OverTheCounter.Logic
{
    ...
    public static class DrifterHotspots
    {
        ...
        {
            new Hotspot("Spot 1", "across from Thompson Construction",
            ...
            new Hotspot("Spot 6", "outside Sauerkraut Supreme Pizza",
            ...
            new Hotspot("Spot 10", "behind taco ticklers",
                new Vector3(-26.37f, 1.06f, 84.62f), 346.2f,
                new Vector3(-0.61f, 5.16f, 77.91f), 5.4f),
            ...
            new Hotspot("Spot 20", "outside the casino",
                new Vector3(22.89f, 1.06f, 84.12f), 66.4f,
                new Vector3(4.90f, 5.16f, 78.08f), 89.2f),
